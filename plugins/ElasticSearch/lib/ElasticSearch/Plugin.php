    ...
    implements Pimcore_API_Plugin_Interface
{
    ...
    public static function install() {
        ...
        if (self::isInstalled()) {
            return "ElasticSearch Plugin successfully installed.";
        } else {
            return "ElasticSearch Plugin could not be installed";
        }
    }
    ...
    public static function uninstall() {
        ...
        if (!self::isInstalled()) {
            return "ElasticSearch Plugin successfully uninstalled.";
        } else {
            return "ElasticSearch Plugin could not be uninstalled";
        }
    }
    ...
    public static function getInstallPath() {
        return PIMCORE_PLUGINS_PATH."/ElasticSearch/install";
    }
}
