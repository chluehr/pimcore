...
<link rel="stylesheet" type="text/css" href="/plugins/ElasticSearch/static/css/frontend.css"/>

<?php if(!$this->omitSearchForm){ ?>

<?php if(!$this->omitJsIncludes){?>

            <script src="/plugins/ElasticSearch/static/js/frontend/jquery-1.3.2.min.js"></script>
            <link rel="stylesheet" href="/plugins/ElasticSearch/static/css/jquery-autocomplete.css" type="text/css" />
            <script type="text/javascript" src="/plugins/ElasticSearch/static/js/frontend/jquery.autocomplete.js"></script>
...
<form method="post" action="?search=true" id="searchForm">
    ...
    <span class="submit_wrapper"><input class="submit" type="submit" value="<?php echo  $this->translate('search_submit')?>"/></span>
         ...
         <script type="text/javascript">
            ...
            $("#query").autocomplete('/plugin/ElasticSearch/frontend/autocomplete/',{
               minChars:3,
               cacheLength: 0,
               extraParams: {
